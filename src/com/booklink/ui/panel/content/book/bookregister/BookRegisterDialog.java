...
public class BookRegisterDialog extends JDialog {
    ...
    public BookRegisterDialog(JFrame parent, Book book) {
        setSize(1440, 800);
        ...
        Date date = Date.from(book.getPublicationDate().atStartOfDay(ZoneId.systemDefault()).toInstant());
        ...
        JTextArea summaryField = new JTextArea(book.getSummary(),3, 20);
        panel.add(new JScrollPane(summaryField));

        panel.add(new JLabel("Description:"));
        JTextArea descriptionField = new JTextArea(book.getDescription(),3, 20);
        ...
        submitButton.addActionListener(e -> {
            ...
            BookRegisterDto dto = new BookRegisterDto(title, author,
                    ...
                    publisher, imageUrl);
            List<String> updatedCategories = List.of(category1, category2);
            try {
                bookController.updateBookWithCategories(dto, book.getId(), updatedCategories);
                JOptionPane.showMessageDialog(this, "도서 수정이 성공적으로 완료되었습니다.",
    ...
    public BookRegisterDialog(JFrame parent) {
        ...
        submitButton.addActionListener(e -> {
            ...
            List<String> inputCategories = List.of(category1, category2);
            BookRegisterDto dto = new BookRegisterDto(title, author,
                    publicationDate, summary, description, price,
                    publisher, imageUrl);
            try {
                bookController.registerBookWithCategories(dto, inputCategories);
